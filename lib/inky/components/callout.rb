  ...
  module Components
    class Callout < Base
      ...
      def transform(node, inner)
        ...
        %(<table #{attributes}class="callout" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width:100%;"><tbody><tr><th class="#{classes}">#{inner}</th><th class="expander"></th></tr></tbody></table>)
      end
    end
  end
end
